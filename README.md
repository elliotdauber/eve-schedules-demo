...
On first load, pick a **display name**. Schedules are created in a namespace matching that name (e.g. `elliot`) and activity is stored under `tenants/elliot/activity/` in Blob.
